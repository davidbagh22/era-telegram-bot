...
from app.handlers.admin import dashboard_block_a, task_review_block2, user_profile_block3_safe, projects_block5_list, projects_block5_decision, projects_block5_team, events_block6, event_activities_block7, partners_admin, panel
