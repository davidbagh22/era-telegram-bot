...
NAVIGATION_PARTICIPANT = """🧭 <b>Куда идём?</b>

Выберите действие — приложение откроется сразу в нужном разделе.

💡 <b>Проекты</b> — идеи, команды и работа над проектами
📅 <b>События</b> — ближайшие мероприятия и регистрация
✅ <b>Мои задачи</b> — ваша текущая работа
⭐ <b>Возможности</b> — предложения, награды и специальные форматы
👥 <b>Сообщество</b> — люди, рейтинг и жизнь ЭРА
👤 <b>Профиль</b> — путь, баллы, достижения и портфолио

Нужен человек, а не раздел? Нажмите <b>«💬 Связь»</b>."""

NAVIGATION_LEADER = NAVIGATION_PARTICIPANT + """

🧭 <b>Режим лидера</b> — команда, задачи и решения по вашему направлению."""

NAVIGATION_ADMIN = NAVIGATION_PARTICIPANT + """

⚙️ <b>Режим администратора</b> — отдельный пульт управления всей ЭРА."""
