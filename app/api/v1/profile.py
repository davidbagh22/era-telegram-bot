...
def _growth_out(growth: GrowthProgress) -> GrowthProgressOut:
    return GrowthProgressOut(
        level=growth.level,
        label=growth.label,
        level_index=growth.level_index,
        level_count=growth.level_count,
    )
...
async def read_profile(
    ...
    return ProfileOut(
        ...
        education_work=portfolio.education_work,
        occupation=portfolio.occupation,
        experience=portfolio.experience,
        motivation=portfolio.motivation,
