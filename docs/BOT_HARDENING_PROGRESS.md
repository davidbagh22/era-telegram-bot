...
Этап 4. QR-система:
- проверить наличие QR-флоу в коде;
- если QR реализован, проверить подпись, срок действия, одноразовость, привязку к мероприятию и пользователю;
- если QR не реализован, зафиксировать отсутствие и не придумывать лишнюю функциональность.
