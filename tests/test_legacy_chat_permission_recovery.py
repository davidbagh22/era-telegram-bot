...
@pytest.mark.asyncio
async def test_restore_general_chat_member_unrestricts_legacy_restricted_member() -> None:
    bot = SimpleNamespace(
...
@pytest.mark.asyncio
async def test_restore_general_chat_member_does_not_touch_banned_or_normal_members() -> None:
