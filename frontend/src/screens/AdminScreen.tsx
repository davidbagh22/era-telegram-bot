    ...
    <div className="era-page" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", minWidth: 0 }}>
      <div style={{ flex: "1 1 auto", minWidth: 0, padding: "1.25rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
        ...
        {group === "people" && !peopleSection && (
          <SectionMenu title="Люди" description="Участники, регистрации, роли и права на данные." options={PEOPLE_SECTIONS} onOpen={setPeopleSection} />
        )}
        {group === "people" && peopleSection && (
        ...
        {group === "work" && !workSection && (
          <SectionMenu title="Работа" description="Проекты, мероприятия, задания и возможности." options={WORK_SECTIONS} onOpen={setWorkSection} />
        )}
        {group === "work" && workSection && (
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        ...
        {group === "comms" && !commsSection && (
          <SectionMenu title="Связь" description="Чаты, рассылки и обратная связь без системных функций." options={COMMS_SECTIONS} onOpen={setCommsSection} />
        )}
        {group === "comms" && commsSection && (
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        ...
        {group === "control" && !controlSection && (
          <SectionMenu title="Контроль" description="Аналитика, здоровье платформы и редкое техническое обслуживание." options={CONTROL_SECTIONS} onOpen={setControlSection} />
        )}
        {group === "control" && controlSection && (
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
