  ...
  return (
    <div
      style={{
        ...
        height: px,
        borderRadius: "50%",
        background: "linear-gradient(135deg, var(--era-violet), var(--era-magenta) 55%, var(--era-red))",
        boxShadow: `0 0 0 1px rgba(255,255,255,0.14) inset, 0 ${px * 0.12}px ${px * 0.32}px rgba(229, 43, 36, 0.35)`,
        display: "flex",
        alignItems: "center",
