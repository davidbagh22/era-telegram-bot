...
// Management is a separate workspace from the participant product. Within
// that workspace, operational control gets its own destination instead of
// hiding analytics/system/maintenance under Overview or Communications.
